...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'Curso_Wp___Fresco_de7de5a31f59c1042540_20210527185421_archive.zip';
	const ARCHIVE_SIZE		 = '75866238';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'de7de5a-27185421';
    const SECONDARY_PACKAGE_HASH = 'd0c2b85-27185421';
	const VERSION			 = '1.4.1';
